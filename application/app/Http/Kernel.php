...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'employee.check.status' => \App\Http\Middleware\EmployeeCheckStatus::class,
        ...
        'employee.check' => \App\Http\Middleware\EmployeeCheck::class,
        'employee.registration.complete' => \App\Http\Middleware\EmployeeRegistrationStep::class,
        'employee.page' => \App\Http\Middleware\EmployeePagePermission::class,
