...
class ListingController extends Controller
{
    ...
    {
        $pageTitle = __('My Listing Offers');
        $listings = Listing::with('listingType')
        ...
        return view($this->activeTemplate . 'employee.listing.index', compact('pageTitle', 'listings'));
    }
    ...
    public function create()
    {
        ...
        return view($this->activeTemplate . 'employee.listing.create', compact('pageTitle', 'listingTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $listing->status = 0; // Pending by default for employees
        $listing->user_id = auth('employee')->id();
        $listing->user_type = 'employee';
        ...
        $notify[] = ['success', __('Listing created successfully and pending for approval')];
    ...
    public function edit($id)
    {
        ...
        $listingTypes = ListingType::active()->latest()->get();
        return view($this->activeTemplate . 'employee.listing.edit', compact('pageTitle', 'listing', 'listingTypes'));
    }
