...
class WithdrawController extends Controller
{
    ...
    public function withdrawStore(Request $request)
    {
        ...
        return to_route('employee.withdraw.preview');
    }
    ...
    public function withdrawSubmit(Request $request)
    {
        ...
        $transaction->agent_id = $withdraw->user_id;
        ...
        return to_route('employee.withdraw.history')->withNotify($notify);
    }

    public function withdrawLog(Request $request)
    {
        $pageTitle = "Withdraw Log";
        $withdraws = Withdrawal::where('user_id', employeeId())->where('status', '!=', 0);
        if ($request->search) {
            $withdraws = $withdraws->where('trx',$request->search);
        }
        $withdraws = $withdraws->with('method')->orderBy('id','desc')->paginate(getPaginate());
        return view($this->activeTemplate.'employee.withdraw.log', compact('pageTitle','withdraws'));
    }
}
