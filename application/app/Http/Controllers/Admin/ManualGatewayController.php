...
class ManualGatewayController extends Controller
{
    ...
    {
        $pageTitle = __('New Manual Gateway');
    ...
    public function store(Request $request)
    {
        ...
        $notify[] = ['success', __(':name manual gateway has been added.', ['name' => $method->name])];
    ...
    public function update(Request $request, $code)
    {
        ...
        $notify[] = ['success', __(':name manual gateway has been updated successfully', ['name' => $method->name])];
    ...
    public function activate($code)
    {
        ...
        $method->status = 1;
        $method->save();
        $notify[] = ['success', __(':name enabled successfully', ['name' => $method->name])];
        return back()->withNotify($notify);
    }
    ...
    public function deactivate($code)
    {
        ...
        $method->status = 0;
        $method->save();
        $notify[] = ['success', __(':name disabled successfully', ['name' => $method->name])];
        return back()->withNotify($notify);
    }
}
