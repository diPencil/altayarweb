...
class NotificationController extends Controller
{
    public function global(){
        $pageTitle = __('Global Template for Notification');
    ...
    public function globalUpdate(Request $request){
        ...
        $notify[] = ['success', __('Global notification settings has been updated successfully')];
    ...
    public function templateUpdate(Request $request,$id){
        ...
        $notify[] = ['success', __('Notification template has been updated successfully')];
        return back()->withNotify($notify);
    }
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        $general = GeneralSetting::first();
        $general->mail_config = (object)$data;
        $general->save();
        $notify[] = ['success', __('Email settings has been updated successfully')];
        return back()->withNotify($notify);
    }
    ...
    public function emailTest(Request $request){
       ...
       if (session('mail_error')) {
           ...
           $notify[] = ['success', __('Email sent to :email successfully', ['email' => $request->email])];
       }
   ...
   public  function smsSetting(){
    ...
    public function smsSettingUpdate(Request $request){
        ...
        $general->save();
        $notify[] = ['success', __('SMS settings has been updated successfully')];
        return back()->withNotify($notify);
    }
    ...
    public function smsTest(Request $request){
        ...
        if (session('sms_error')) {
            ...
            $notify[] = ['success', __('SMS sent to :mobile successfully', ['mobile' => $request->mobile])];
        }
