        ...
        <div class="col-lg-12">
            <div class="base--card">
                <div class="text-end mb-3">
                    <a href="{{route('employee.ticket') }}" class="btn btn--lg btn--base mb-2 pills">@lang('My Support Ticket')</a>
                </div>
                <form action="{{route('employee.ticket.store')}}" method="post" enctype="multipart/form-data"
