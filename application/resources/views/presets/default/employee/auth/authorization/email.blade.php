            ...
            <div class="col-md-8 col-lg-7 col-xl-5">
                <div class="base--card">
                    <div class="verification-area">
                        ...
                        <form action="{{route('employee.verify.email')}}" method="POST" class="submit-form">
                            @csrf
                            <p class="verification-text mb-3">@lang('A 6 digit verification code sent to your email address'): {{
                                showEmailAddress(Employee()->email) }}</p>
                            ...
                            <div class="mb-3">
                                <p>
                                    @lang('If you don\'t get any code'), <a href="{{route('employee.send.verify.code', 'email')}}" class="text--base-two"> @lang('Try again')</a>
                                </p>
