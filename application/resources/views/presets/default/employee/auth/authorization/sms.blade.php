            ...
            <div class="col-md-8 col-lg-7 col-xl-5">
                <div class="base--card">
                    <div class="verification-area">
                        ...
                        <form action="{{route('employee.verify.mobile')}}" method="POST" class="submit-form">
                            @csrf
                            <p class="verification-text mb-3">@lang('A 6 digit verification code sent to your mobile number') : +{{  showMobileNumber(Employee()->mobile) }}</p>
                            ...
                            <div class="form-group">
                                <p>
                                    @lang('If you don\'t get any code'), <a href="{{route('employee.send.verify.code', 'phone')}}" class="forget-pass text--base-two">  @lang('Try again')</a>
                                </p>
