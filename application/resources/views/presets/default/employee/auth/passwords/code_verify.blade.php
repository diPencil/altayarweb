            ...
            <div class="col-md-8 col-lg-7 col-xl-5">
                <div class="base--card">
                    <div class="verification-area">
                        ...
                        <form action="{{ route('employee.password.verify.code') }}" method="POST" class="submit-form">
                            @csrf
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('employee.password.request') }}" class="text--base-two">@lang('Try to send again')</a>
                            </div>
                        </form>
                    </div>
                </div>
