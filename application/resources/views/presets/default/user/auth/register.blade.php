                ...
                <div class="login-box w--100">
                    ...
                    <div class="form--wrap">
                        <form action="{{ route('user.register') }}" method="POST" class="verify-gcaptcha">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4 form-group">
                                        ...
                                        <input class="form--control pills" name="firstname"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4 form-group">
                                        ...
                                        <input class="form--control pills" name="lastname"
                                        ...
                                        <select name="country" class="form-select form--control form--select pills"
                                            ...
                                            @foreach ($countries as $key => $country)
                                                <option data-mobile_code="{{ $country->dial_code }}"
                                                    ...
                                                    @selected($country->country == 'Saudi Arabia')>
                                                    {{ __($country->country) }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4 form-group">
                                        <label class="mb-2 form--label">@lang('Gender')</label>
                                        <select name="gender" class="form-select form--control form--select pills" required>
                            ...
                            <div class="mb-4">
                                <div class="col-lg-12check d-flex align-items-center gap-2">
                                        <input class="form-check-input" type="checkbox" id="agree" @checked(old('agree')) name="agree" required style="margin-top: 0; width: 18px; height: 18px; cursor: pointer;">
                                        <label class="form-check-label" for="agree" style="cursor: pointer; line-height: 1;required>
                                        <label for="agree">
                                            @lang('I agree to all Terms & Policies of Altayarvip Club.')
                                            @if ($general->agree)
                                                @foreach ($policyPages as $policy)
                                                    <a href="{{ policy_detail_url($policy) }}"
                                                        class="text--base-two">
