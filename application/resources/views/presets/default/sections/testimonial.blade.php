@php
    ...
    // Custom hardcoded testimonials for a more "hardcoded/real" feel as requested
    $customTestimonials = [
        [
            'name' => 'فهد بن ناصر العتيبي',
            'designation' => 'الرياض - رجل أعمال',
            'description' => 'بيض الله وجيهكم على هالخدمة، بصراحة الطيار VIP غيروا مفهوم السفر عندنا. حجزت العضوية الماسية والخصومات اللي حصلتها خيالية، والدفع آمن جداً يخليك مرتاح وأنت تحجز. الله يبارك لكم.',
            'star_count' => 5,
                ...
                <div class="section-content mb-50">
                    <div class="title-wrap">
                        <h6 class="heading third--font text-center fs--32 fw--700 text--base mb-0" dir="auto">
                            {{ getLangContent($testimonialContent->data_values, 'title') }}</h6>
                        <h2 class="title text-center mb-3 fs--40 fw--800 wow animate__animated animate__fadeInUp"
                             data-wow-delay="0.2s" dir="auto">{{ getLangContent($testimonialContent->data_values, 'heading') }}
                        </h2>
                        <p class="subtitle wow animate__animated animate__fadeInUp text-center fs-16 fw--400"
                            data-wow-delay="0.3s" dir="auto">{{ getLangContent($testimonialContent->data_values, 'sub_heading') }}</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="content-wrap">
                                    <p class="description text-center fw--500" dir="auto">
                                        {{ $item['description'] }}
                                    </p>
                                </div>
                                <div class="d-flex justify-content-center align-items-center w--100">
                                    <div class="d-flex flex-column justify-content-center align-items-center gap--12">
                                        ...
                                        <div
                                            ...
                                            <h6 class="fs--22 text-center fw--600 mb-0" dir="auto">
                                                {{ $item['name'] }}</h6>
                                            <p class="mb-1 text-center fs--14" dir="auto">
                                                {{ $item['designation'] }}</p>
