                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name_ar" class="form-control"
                                                            placeholder="@lang('Name (Arabic)')" value="{{ old('name_ar') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="location_ar" class="form-control"
                                                            value="{{old('location_ar')}}"  placeholder="@lang('Location (Arabic)')">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="count" class="form-control"
                                                            placeholder="@lang('e.g. 100+ Destinations')" value="{{ old('count') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
