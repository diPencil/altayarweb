                    ...
                    <table class="table table--light style--two custom-data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text--small badge font-weight-normal {{ $item->text_align ? 'badge--warning' : 'badge--primary' }}">
                                        {{ $item->text_align ? __('RTL') : __('LTR') }}
                                    </span>
                                </td>
                                <td>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="{{ route('admin.language.manage.store')}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <label>@lang('Text Direction')</label>
                        <div class="col-sm-12">
