                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        <td>
                                            @if ($log->Employee)
                                                <a
                                                    href="{{ route('admin.employees.detail', $log->Employee_id) }}">{{ $log->Employee->fullname ?? $log->Employee->username }}</a>
                                            @else
                                        ...
                                        <td>
                                            <button title="@lang('Details')" class="btn btn-sm btn--primary notifyDetail"
                                                ...
                                                @if ($log->notification_type == 'email') data-message="{{ route('admin.employee.report.email.details', $log->id) }}" @else
...
@push('breadcrumb-plugins')
    @if (isset($user))
        <a href="{{ route('admin.employees.notification.single', $user->id) }}" class="btn btn--primary btn-sm"><i
